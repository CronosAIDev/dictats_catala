...
| F62 | Gráfico de cabecera 1024×500 para Play | Hecho en `docs/sections/publicacio/assets/`: PNG a medida exacta más la fuente HTML y el script de captura para regenerarlo si cambia el nombre o la promesa. Identidad de la app (theme_color, icono real) y la promesa de la #23, sin letra pequeña. Las capturas de pantalla siguen pendientes (necesitan datos reales en la app desplegada) | **Hecho (v10)** | Media |
