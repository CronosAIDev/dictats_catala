...
| F64 | Botón para reportar contenido generado con IA | Play trata las apps que generan contenido con IA como área regulada y exige **reportar contenido ofensivo desde dentro de la app**. Las explicaciones de cada error las escribe el modelo, así que Dictats entra. Hoy no hay ninguna vía. Es barato —un botón por explicación— y evita un rechazo en la revisión. No estaba en la Issue #19 | Pendiente | Alta |
